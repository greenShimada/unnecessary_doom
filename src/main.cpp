...
int main() {
  ...
  // Cara... VBO e Vertex Buffer Object, e aloca um espaco direto na GPU pra
  // processar os shaders.... O VAO grava as configuracoes do atributo
...
void mouse_callback(GLFWwindow* window, double xposIn, double yposIn) {
  ...
  float yoffset =
      lastY - ypos;  // Invertido porque a coordenada y vem do bottom Top
